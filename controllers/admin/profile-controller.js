...
module.exports.editPatch = async(req,res) => {
    try {
        ...
        res.redirect(`/admin/profile/edit/${req.params.id}`);
    }
}

//[GET] /admin/profile/change-password/:id
...
//[PATCH] /admin/profile/change-password/:id
module.exports.changePasswordPatch = async(req,res) => {
    try {
        ...
        if(account.password !== md5(currentPassword)) {
            ...
            return res.redirect(`/admin/profile/change-password/${req.params.id}`);
        }
        ...
        res.redirect(`/admin/profile/change-password/${req.params.id}`);
    }
}